...
export function Reports() {
  ...
  return <PageContainer context="admin" className={styles.stack}>
    ...
    <Alert tone="info"><p>Application stages and verified outcomes are different records.</p><p>An accepted application does not confirm that you joined. Record the joining separately.</p></Alert>
